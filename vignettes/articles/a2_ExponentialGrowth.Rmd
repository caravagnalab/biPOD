...
bipod <- biPOD::fit(bipod, growth_type = "exponential", model_type = "gauss", prior = "uniform", a = 0, b = 5, g = 5)
```
...
bipod_g <- biPOD::fit(bipod_g, growth_type = "exponential", model_type = "gauss", prior = "uniform", a = 0, b = 5, g = 5)
```
