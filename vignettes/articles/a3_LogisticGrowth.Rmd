...
biPOD::plot_evolution(bipod)
bipod <- biPOD::fit(bipod, growth_type = "logistic", model_type = "gauss", prior = "invgamma", a = 1, b = 1)
```
...
bipod_vb <- biPOD::fit(bipod_vb, growth_type = "logistic", model_type = "gauss", prior = "invgamma", a = 2, b = 2, variational = TRUE)
```
