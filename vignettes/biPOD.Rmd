...
It supports: (i) fitting growth with **known breakpoints**, (ii) **inferring breakpoints** when unknown, and (iii) a **two-population (sensitive/resistant)** model typical in treatment–relapse settings.
