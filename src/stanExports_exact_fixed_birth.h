...
namespace model_exact_fixed_birth_namespace {
using std::istream;
using std::string;
...
private:
        ...
        std::vector<double> T;
public:
    model_exact_fixed_birth(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exact_fixed_birth_namespace::model_exact_fixed_birth";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exact_fixed_birth_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_exact_fixed_birth";
    }
...
typedef model_exact_fixed_birth_namespace::model_exact_fixed_birth stan_model;
#ifndef USING_R
