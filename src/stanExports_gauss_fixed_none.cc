...
#include "stanExports_gauss_fixed_none.h"

RCPP_MODULE(stan_fit4gauss_fixed_none_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gauss_fixed_none")
