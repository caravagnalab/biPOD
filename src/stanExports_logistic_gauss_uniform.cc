...
#include "stanExports_logistic_gauss_uniform.h"

RCPP_MODULE(stan_fit4logistic_gauss_uniform_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_logistic_gauss_uniform")
