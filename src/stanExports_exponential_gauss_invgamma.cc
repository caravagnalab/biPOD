...
#include "stanExports_exponential_gauss_invgamma.h"

RCPP_MODULE(stan_fit4exponential_gauss_invgamma_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exponential_gauss_invgamma")
