...
namespace model_gauss_fixed_death_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gauss_fixed_death");
    reader.add_event(59, 57, "end", "model_gauss_fixed_death");
    return reader;
}
...
class model_gauss_fixed_death
  : public stan::model::model_base_crtp<model_gauss_fixed_death> {
private:
        int S;
        double n0;
        std::vector<double> N;
        std::vector<double> T;
public:
    model_gauss_fixed_death(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gauss_fixed_death_namespace::model_gauss_fixed_death";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("lambda", "S", S);
        context__.validate_dims("parameter initialization", "lambda", "double", context__.to_vec(S));
        std::vector<double> lambda(S, double(0));
        size_t lambda_k_0_max__ = S;
        for (size_t k_0__ = 0; k_0__ < lambda_k_0_max__; ++k_0__) {
            lambda[k_0__] = vals_r__[pos__++];
        }
        size_t lambda_i_0_max__ = S;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(inv_gamma_log<propto__>(mu, 2, 2));
            current_statement_begin__ = 38;
            for (int i = 1; i <= S; ++i) {
                current_statement_begin__ = 39;
                lp_accum__.add(inv_gamma_log<propto__>(get_base1(lambda, i, "lambda", 1), 2, 2));
                current_statement_begin__ = 40;
                if (as_bool(logical_eq(i, 1))) {
                    current_statement_begin__ = 41;
                    lp_accum__.add(normal_log<propto__>(get_base1(N, i, "N", 1), mean_t(n0, get_base1(lambda, i, "lambda", 1), mu, get_base1(T, 1, "T", 1), pstream__), sigma_t(n0, get_base1(lambda, i, "lambda", 1), mu, get_base1(T, 1, "T", 1), pstream__)));
                } else {
                    current_statement_begin__ = 43;
                    lp_accum__.add(normal_log<propto__>(get_base1(N, i, "N", 1), mean_t(get_base1(N, (i - 1), "N", 1), get_base1(lambda, i, "lambda", 1), mu, (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), pstream__), sigma_t(get_base1(N, (i - 1), "N", 1), get_base1(lambda, i, "lambda", 1), mu, (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), pstream__)));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gauss_fixed_death_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
            ...
            for (int i = 1; i <= S; ++i) {
                ...
                if (as_bool(logical_eq(i, 1))) {
                    ...
                    stan::model::assign(N_rep, 
                                ...
                                normal_rng(mean_t(n0, get_base1(lambda, i, "lambda", 1), mu, get_base1(T, 1, "T", 1), pstream__), sigma_t(n0, get_base1(lambda, i, "lambda", 1), mu, get_base1(T, 1, "T", 1), pstream__), base_rng__), 
                                "assigning variable N_rep");
                } else {
                    current_statement_begin__ = 54;
                    stan::model::assign(N_rep, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                normal_rng(mean_t(get_base1(N, (i - 1), "N", 1), get_base1(lambda, i, "lambda", 1), mu, (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), pstream__), sigma_t(get_base1(N, (i - 1), "N", 1), get_base1(lambda, i, "lambda", 1), mu, (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), pstream__), base_rng__), 
                                "assigning variable N_rep");
                }
            }
    ...
    std::string model_name() const {
        return "model_gauss_fixed_death";
    }
...
typedef model_gauss_fixed_death_namespace::model_gauss_fixed_death stan_model;
#ifndef USING_R
