...
namespace model_exact_exp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exact_exp");
    reader.add_event(139, 137, "end", "model_exact_exp");
    return reader;
}
...
class model_exact_exp
  : public stan::model::model_base_crtp<model_exact_exp> {
private:
        int S;
        int n0;
        std::vector<int> N;
        ...
        double prior_par;
public:
    model_exact_exp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exact_exp_namespace::model_exact_exp";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exact_exp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_exact_exp_namespace::model_exact_exp stan_model;
#ifndef USING_R
