...
#include "stanExports_exponential_start_at_1.h"

RCPP_MODULE(stan_fit4exponential_start_at_1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exponential_start_at_1")
