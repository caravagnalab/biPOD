...
namespace model_exponential_exact_uniform_namespace {
using std::istream;
using std::string;
...
class model_exponential_exact_uniform
  : public stan::model::model_base_crtp<model_exponential_exact_uniform> {
private:
        int S;
        int n0;
        std::vector<int> N;
        ...
        double g;
public:
    model_exponential_exact_uniform(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exponential_exact_uniform_namespace::model_exponential_exact_uniform";
    ...
    ~model_exponential_exact_uniform() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exponential_exact_uniform_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_exponential_exact_uniform";
    }
...
typedef model_exponential_exact_uniform_namespace::model_exponential_exact_uniform stan_model;
#ifndef USING_R
