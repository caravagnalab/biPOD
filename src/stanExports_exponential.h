...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(66, 64, "end", "model_exponential");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= S; ++i) {
                ...
                lp_accum__.add(poisson_log(get_base1(N, i, "N", 1), mean_t(get_base1(T, i, "T", 1), t0, t_array, rho, pstream__)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int i = 1; i <= S; ++i) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            poisson_log(get_base1(N, i, "N", 1), mean_t(get_base1(T, i, "T", 1), t0, t_array, rho, pstream__)), 
                            "assigning variable log_lik");
                current_statement_begin__ = 62;
                stan::model::assign(N_rep, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            poisson_rng(mean_t(get_base1(T, i, "T", 1), t0, t_array, rho, pstream__), base_rng__), 
