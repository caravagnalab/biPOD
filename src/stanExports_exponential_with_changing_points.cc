...
#include "stanExports_exponential_with_changing_points.h"

RCPP_MODULE(stan_fit4exponential_with_changing_points_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exponential_with_changing_points")
