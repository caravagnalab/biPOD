...
#include "stanExports_poisson_exp.h"

RCPP_MODULE(stan_fit4poisson_exp_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_poisson_exp")
