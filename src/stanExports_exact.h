...
namespace model_exact_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exact");
    reader.add_event(143, 141, "end", "model_exact");
    return reader;
}
...
class model_exact
  : public stan::model::model_base_crtp<model_exact> {
private:
        int S;
        int n0;
        std::vector<int> N;
        ...
        double prior_par;
public:
    model_exact(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exact_namespace::model_exact";
            ...
            if (as_bool(logical_eq(k, 0))) {
                ...
                for (int i = 1; i <= S; ++i) {
                    ...
                    if (as_bool(logical_eq(i, 1))) {
                        ...
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), n0, get_base1(T, i, "T", 1), get_base1(lambda, 1, "lambda", 1), get_base1(mu, 1, "mu", 1), pstream__));
                    } else {
                        current_statement_begin__ = 96;
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), get_base1(N, (i - 1), "N", 1), (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), get_base1(lambda, 1, "lambda", 1), get_base1(mu, 1, "mu", 1), pstream__));
                    }
                }
                ...
                for (int i = 1; i <= S; ++i) {
                    ...
                    if (as_bool(logical_eq(i, 1))) {
                        ...
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), n0, get_base1(T, i, "T", 1), get_base1(lambda, 1, "lambda", 1), get_base1(mu, i, "mu", 1), pstream__));
                    } else {
                        current_statement_begin__ = 109;
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), get_base1(N, (i - 1), "N", 1), (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), get_base1(lambda, 1, "lambda", 1), get_base1(mu, i, "mu", 1), pstream__));
                    }
                }
            } else {
                ...
                for (int i = 1; i <= S; ++i) {
                    ...
                    if (as_bool(logical_eq(i, 1))) {
                        ...
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), n0, get_base1(T, i, "T", 1), get_base1(lambda, i, "lambda", 1), get_base1(mu, 1, "mu", 1), pstream__));
                    } else {
                        current_statement_begin__ = 121;
                        lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), get_base1(N, (i - 1), "N", 1), (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), get_base1(lambda, i, "lambda", 1), get_base1(mu, 1, "mu", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exact_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_exact_namespace::model_exact stan_model;
#ifndef USING_R
