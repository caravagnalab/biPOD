...
namespace model_exact_fixed_death_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_exact_fixed_death");
    reader.add_event(109, 107, "end", "model_exact_fixed_death");
    return reader;
}
...
class model_exact_fixed_death
  : public stan::model::model_base_crtp<model_exact_fixed_death> {
private:
        int S;
        int n0;
        std::vector<int> N;
        std::vector<double> T;
public:
    model_exact_fixed_death(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exact_fixed_death_namespace::model_exact_fixed_death";
        ...
        try {
            ...
            for (int i = 1; i <= S; ++i) {
                ...
                if (as_bool(logical_eq(i, 1))) {
                    ...
                    lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), n0, get_base1(T, i, "T", 1), get_base1(lambda, i, "lambda", 1), mu, pstream__));
                } else {
                    current_statement_begin__ = 93;
                    lp_accum__.add(birthDeathLike_log<propto__>(get_base1(N, i, "N", 1), get_base1(N, (i - 1), "N", 1), (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), get_base1(lambda, i, "lambda", 1), mu, pstream__));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exact_fixed_death_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
            ...
            for (int i = 1; i <= S; ++i) {
                ...
                if (as_bool(logical_eq(i, 1))) {
                    ...
                    stan::model::assign(N_rep, 
                                ...
                                birthDeathLike_rng(n0, get_base1(T, i, "T", 1), get_base1(lambda, i, "lambda", 1), mu, base_rng__, pstream__), 
                                "assigning variable N_rep");
                } else {
                    current_statement_begin__ = 104;
                    stan::model::assign(N_rep, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                birthDeathLike_rng(get_base1(N, (i - 1), "N", 1), (get_base1(T, i, "T", 1) - get_base1(T, (i - 1), "T", 1)), get_base1(lambda, i, "lambda", 1), mu, base_rng__, pstream__), 
                                "assigning variable N_rep");
                }
            }
    ...
    std::string model_name() const {
        return "model_exact_fixed_death";
    }
...
typedef model_exact_fixed_death_namespace::model_exact_fixed_death stan_model;
#ifndef USING_R
