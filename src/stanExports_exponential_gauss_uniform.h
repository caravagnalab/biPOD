...
namespace model_exponential_gauss_uniform_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(97, 95, "end", "model_exponential_gauss_uniform");
    return reader;
}
...
class model_exponential_gauss_uniform
  : public stan::model::model_base_crtp<model_exponential_gauss_uniform> {
private:
        int S;
        double n0;
        std::vector<double> N;
        ...
        double g;
public:
    model_exponential_gauss_uniform(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_exponential_gauss_uniform_namespace::model_exponential_gauss_uniform";
    ...
    ~model_exponential_gauss_uniform() { }
            ...
            if (as_bool(logical_eq(k, 0))) {
                ...
                for (int i = 1; i <= S; ++i) {
                    ...
                    if (as_bool(logical_eq(i, 1))) {
                        ...
                        lp_accum__.add(normal_log<propto__>(get_base1(N, i, "N", 1), mean_t(n0, lambda, get_base1(mu, i, "mu", 1), get_base1(T, 1, "T", 1), pstream__), sigma_t(n0, lambda, get_base1(mu, i, "mu", 1), get_base1(T, 1, "T", 1), pstream__)));
                    } else {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_exponential_gauss_uniform_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
            ...
            if (as_bool(logical_eq(k, 0))) {
                ...
                for (int i = 1; i <= S; ++i) {
                    ...
                    stan::model::assign(N_rep, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                normal_rng(mean_t(n0, lambda, get_base1(mu, 1, "mu", 1), get_base1(T, i, "T", 1), pstream__), sigma_t(n0, lambda, get_base1(mu, 1, "mu", 1), get_base1(T, i, "T", 1), pstream__), base_rng__), 
    ...
    std::string model_name() const {
        return "model_exponential_gauss_uniform";
    }
...
typedef model_exponential_gauss_uniform_namespace::model_exponential_gauss_uniform stan_model;
#ifndef USING_R
