...
#include "stanExports_exact_fixed_death.h"

RCPP_MODULE(stan_fit4exact_fixed_death_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exact_fixed_death")
