...
#include "stanExports_exponential_exact_uniform.h"

RCPP_MODULE(stan_fit4exponential_exact_uniform_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_exponential_exact_uniform")
