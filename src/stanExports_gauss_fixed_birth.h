...
namespace model_gauss_fixed_birth_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gauss_fixed_birth");
    reader.add_event(59, 57, "end", "model_gauss_fixed_birth");
    return reader;
}
...
class model_gauss_fixed_birth
  : public stan::model::model_base_crtp<model_gauss_fixed_birth> {
private:
        int S;
        double n0;
        std::vector<double> N;
        std::vector<double> T;
public:
    model_gauss_fixed_birth(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gauss_fixed_birth_namespace::model_gauss_fixed_birth";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gauss_fixed_birth_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_gauss_fixed_birth";
    }
...
typedef model_gauss_fixed_birth_namespace::model_gauss_fixed_birth stan_model;
#ifndef USING_R
